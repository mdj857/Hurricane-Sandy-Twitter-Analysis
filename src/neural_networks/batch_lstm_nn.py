...
# compile keras model
model = Sequential()
model.add(LSTM(200, input_shape = (213,), input_dim = 3, return_sequences = True))
...
model.fit_generator(batch_gen, steps_per_epoch=3000, epochs=1, verbose=1, shuffle=True)
